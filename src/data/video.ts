...
export const replaceLogic = [
  ...
  { pattern: /pop.?up/g, result: "팝업" },
  { pattern: /set.?up|셑업|샛업|샡업/g, result: "셋업" },
  ...
  { pattern: /불구녕|fire.?watch/g, result: "불구경" },
...
const data: VideoRaw[] = [
  {
    ...
    subtitle: "홍동균",
    slug: "pedalboard",
    setlist: [S.glow, S.black, S.shore],
    info: ["페달보드"],
  ...
  /*
  {
    ...
    info: [I.fire(2017), "셋리스트", "플레이리스트"],
    links: [yt("https://www.youtube.com/watch?v=guQtKZ3IYlg")],
    date: "2025.05.21",
  },
  {
    title: "불구경 2016",

...
export const ScheduleModal = ({ schedule, closeLink }: ScheduleModalProps) => {
  ...
  return (
    <ServerModal closeLink={closeLink}>
      ...
      <div className="w-[80vw] max-w-[50vh] md:w-80 md:max-w-80 md:h-[70vw] md:max-h-[80vh] bg-white font-pretendard py-2 px-3 md:px-4 md:py-4 shrink rounded-b md:rounded-l-none md:rounded-r z-40">
        <ModalBody
          title={title}
          date={dateText}
          content={content}

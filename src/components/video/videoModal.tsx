...
export const VideoModal = ({ video }: VideoModalProps) => {
  ...
  return (
    <div className="w-full h-full max-h-[85vh] overflow-hidden flex flex-col items-center justify-center">
      <DivUnclick className="w-[80vw] h-[45vw] max-w-[89vh] max-h-[50vh] relative shrink-0 rounded-t overflow-hidden z-40">
        <Image
          src={`/video/${thumbnail}`}
          alt="thumbnail"
          fill
      ...
      <DivUnclick className="w-[80vw] max-w-[89vh] bg-white font-pretendard py-2 px-3 shrink rounded-b z-40 overflow-y-auto">
        <ModalBody

...
export const VideoSearchBar = ({ target, search }: VideoSearchBarProps) => (
  <div className="w-full max-w-4xl md:px-1.5">
    <div className="w-full flex justify-end bg-slate-100 md:py-1">
      <div className="w-0 md:w-40 hidden md:flex items-center justify-center space-x-2">
        ...
        <div className="bg-white px-1.5 rounded-sm border-slate-500 border flex items-center">
          ...
          <Image
            ...
            height={16}
            alt="chevron"
            className="w-4 h-4 cursor-pointer rotate-90 ml-0.5 -mr-0.5 mt-px"
          />
        </div>
      </div>
